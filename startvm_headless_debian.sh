...
# "Fedora 19 Desktop 64" {a6fc6c4d-17aa-4e14-ab69-5b21e43ac326}
...
givenIP=`VBoxManage guestproperty enumerate "openSuSE 13.2 64bit" | grep -o "Net.*IP.*value: [0-9\.]*" | cut -f2 -d ":" | sed "s/^\s*//" | sed "s/\s*$//"`
